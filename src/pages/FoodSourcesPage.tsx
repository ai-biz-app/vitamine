      ...
      <main style={{ paddingTop: 60 }}>
        ...
        <section className="w-full pb-8 px-6" style={{ background: '#fafaf8' }}>
          <div className="content-max">
            <Link to="/supplement-guide" className="block rounded-xl p-6 transition-all duration-300 hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg, rgba(74, 222, 128, 0.08) 0%, rgba(96, 165, 250, 0.08) 100%)', border: '1px solid rgba(74, 222, 128, 0.2)', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
                    ...
                    {vitamins.map((v, i) => {
                      ...
                      return (
                        <tr key={v.id} style={{ borderBottom: i < vitamins.length - 1 ? '1px solid rgba(0,0,0,0.04)' : 'none' }}>
                          <td className="px-6 py-4"><Link to={`/vitamins/${v.id}`} className="flex items-center gap-3 group">
