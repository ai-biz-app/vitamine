        ...
        <section className="w-full pb-24 px-6" style={{ background: '#fafaf8' }}>
          <div className="content-max space-y-12">
            {diseases.map((disease, i) => (
              <article key={disease.id} ref={(el) => { cardRefs.current[i] = el }} className="rounded-2xl overflow-hidden bg-white" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}>
